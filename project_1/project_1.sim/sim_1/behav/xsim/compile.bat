...
REM
REM Generated by Vivado on Mon Aug 11 23:20:04 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj sim_tensorcore_vlog.prj"
call xvlog  --incr --relax -L uvm -prj sim_tensorcore_vlog.prj -log xvlog.log
